...
public class Heap {
    ...
    // Complejidad: O(log n)
    //! Todas esas operaciones son O(1)
...
/* Invariante de representación (para Heap)
     ...
     Por cada nodo padre tendrá a lo sumo 2 hijos
     Para cada nodo en el heap, su valor de votos va a ser mayor o igual que el valor de los votos en sus hijos.
     El heap cumple que por cada nodo padre, este será mayor o igual que sus hijos
*/
